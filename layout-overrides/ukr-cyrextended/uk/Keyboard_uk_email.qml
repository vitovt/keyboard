...
KeyPad {
    ...
    Column {
        ...
        Row {
            ...
            CharKey { label: "ї"; shifted: "Ї"; extended: ["ъ", "ʼ"]; extendedShifted: ["Ъ", "ʼ"]; rightSide: true; }
        }
        ...
        Row {
            ...
            CharKey { label: "і"; shifted: "І"; extended: ["ы"]; extendedShifted: ["Ы"] }
            ...
            CharKey { label: "є"; shifted: "Є"; extended: ["э"]; extendedShifted: ["Э"]; rightSide: true; }
        }
